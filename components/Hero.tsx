        ...
        <div className={style.contentWrapper}>
          ...
          <div className={style.cardContainer}>
            ...
            <div className={style.infoContainer}>
              <img
                src="https://lh3.googleusercontent.com/a-/AOh14GjQenYGlUOSrBG_YqcTsLk3PygDnv7O8a7KwUo4=s96-c-rg-br100"
                alt="user photo"
                className="h-[2.25rem] rounded-full"
              />
              <div className={style.author}>
                <div className={style.name}>Juan David</div>
                <a className="text-[#1868b7]" href="https://opensea.io/">
                  juandsoto
                </a>
              </div>
            </div>
